...
package finalprojectbi.loadfromjson_0_1;
...
/**
 * Job: LoadFromJson Purpose: Transfrom the json data into delimited text<br>
 * Description: the purpose of this job is to transfrom the Json File that shows
 * the locations of each market company into a delimited text file that we will
 * use later. <br>
 * 
 ...
 * @status
 */
public class LoadFromJson implements TalendJob {
	...
	private final String jobName = "LoadFromJson";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadFromJson.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_FINALPROJECTBI_LoadFromJson = new byte[0];
		static byte[] commonByteArray_FINALPROJECTBI_LoadFromJson = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINALPROJECTBI_LoadFromJson.length) {
					if (length < 1024 && commonByteArray_FINALPROJECTBI_LoadFromJson.length == 0) {
						commonByteArray_FINALPROJECTBI_LoadFromJson = new byte[1024];
					} else {
						commonByteArray_FINALPROJECTBI_LoadFromJson = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINALPROJECTBI_LoadFromJson, 0, length);
				strReturn = new String(commonByteArray_FINALPROJECTBI_LoadFromJson, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FINALPROJECTBI_LoadFromJson, 0, length);
				strReturn = new String(commonByteArray_FINALPROJECTBI_LoadFromJson, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINALPROJECTBI_LoadFromJson) {
	...
	public void tFileInputJSON_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "ID", "City", });
...
///////////////////////    			
				...
				String loopPath_tFileInputJSON_1 = "$.cities[*]";
				...
				try {
					filenameOrStream_tFileInputJSON_1 = "C:/Users/lenovo/Desktop/BI project/Principe/cities.json";
				...
				for (Object row_tFileInputJSON_1 : resultset_tFileInputJSON_1) {
					...
					try {
						...
						try {
							...
							row1.City = value_tFileInputJSON_1 == null ?
...
///////////////////////		
						...
						if (row1.City != null) { //
							row_tLogRow_1[1] = String.valueOf(row1.City);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final LoadFromJson LoadFromJsonClass = new LoadFromJson();

		int exitCode = LoadFromJsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadFromJson.class.getClassLoader()
					.getResourceAsStream("finalprojectbi/loadfromjson_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadFromJson.class.getClassLoader()
		...
		new Thread() {
			public void run() {
				...
				} catch (java.lang.Error e_tFileInputJSON_1) {
					globalMap.put("tFileInputJSON_1_SUBPROCESS_STATE", -1);
					((java.util.Map) threadLocal.get()).put("status", "failure");
					throw e_tFileInputJSON_1;
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadFromJson");
		}
...
/************************************************************************************************
 * 47685 characters generated by Talend Open Studio for Big Data on the January
 * 18, 2023 at 10:38:32 PM CET
 ************************************************************************************************/
